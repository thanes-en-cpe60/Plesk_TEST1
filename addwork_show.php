                ...
                <div class="col-12 pt-3">
                  <div class="main">                  
                    <div class="input-group">
						...
						<a href="addwork_edit.php?work-edit-btn=<?php echo $job_id; ?>" >
                         <button class="btn btn-primary" type="button" name="work-edit-btn" value="แก้ไข" onClick="this.form.action='subopn_add.php'; submit()"  
