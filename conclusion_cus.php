...
<!-- -------------------------------- Main --------------------------------- -->
            ...
            <div class="layout">
              <h3>ผลสรุปยอดสั่งซื้อของลูกค้า</h3>

              <div class="header-top row">
                <div class="col-12 mt-3">
                  <ul class="nav nav-tabs" id="myTab" role="tablist">
                  <li class="nav-item">
                      <a class="nav-link" id="mode-tab" href="conclusion.php">โมเดล</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active" id="model-sub-tab" href="conclusion_cus.php">ลูกค้า</a>
                    </li>
                  </ul>           
                </div>
              </div>
...
<!-- ----------------------------------------------------------------------- -->
    ...
    <script> //chart bar
        ...
        function showGraph(){
            {
                $.post("cus_all.php",$("#testform" ).serialize(),  function(data) {
                    console.log(data);
                    let name = [];
                    let score = [];
                    for (let i in data) {
